...
/*Purpose: Map clue function
Author: Midhousha Anura , McMaster University
...
This program is the same as map function however altered slighty for testing purposes. The following changes are:
